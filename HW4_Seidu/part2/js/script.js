...
Sources: https://www.w3schools.com/js/js_jquery_selectors.asp, https://www.youtube.com/watch?v=dh_3j_v8USU (JQuery UI Tutorial | Sliders)
*/
...
$(document).ready(function(){
    ...
    $("columnSlider").slider({
        ...
        change: function(_event, ui) {
            document.getElementById('mincolvalue').value = ui.values[0];
            document.getElementById('maxcolvalue').value = ui.values[1];
            createTable();
        }
    });
    ...
    $("rowSlider").slider({
        ...
        values: [-50,50],
        change: function(_event, ui) {
            document.getElementById('minrowvalue').value = ui.values[0];
            document.getElementById('maxrowvalue').value = ui.values[1];
            createTable();
        }
    });
    
    //use .change function to two-way bind slider values
    $('#minrowvalue').change(function() {
        $("rowSlider").slider('values', 0, parseInt(document.getElementById('minrowvalue').value));
    });
    $('#mincolvalue').change(function() {
        $("columnSlider").slider('values', 0, parseInt(document.getElementById('mincolvalue').value));
    });
    $('#maxrowvalue').change(function() {
        $("rowSlider").slider('values', 1, parseInt(document.getElementById('maxrowvalue').value));
    });
    $('#maxcolvalue').change(function() {
        $("columnSlider").slider('values', 1, parseInt(document.getElementById('maxcolvalue').value));
    });
